...
KONECT started out in December 2008 at the Technical University of
Berlin's DAI Laboratory, as evaluation for Jérôme Kunegis's
ICML 2009 paper \emph{Learning Spectral Graph Transformations for Link
  Prediction} \citep{kunegis:spectral-transformation}, codenamed
\emph{Spectral Transformation}.  It then consisted of a collection of
network dataset, and spectral link prediction methods.  Later, more
datasets were added and the codebase was called the \emph{Graph Store}.
When Jérôme moved from Berlin to Koblenz the code was renamed \emph{Web
  Store}, in line with Koblenz' Institute for Web Science and
Technologies.  The name \emph{KONECT} was adopted sometime in 2011.  The
KONECT website was created in 2011 at the University of
Koblenz--Landau, under
...
and 2016, various parts of KONECT were placed on GitHub under the GNU
...
\begin{wrapfigure}{r}{0.40\textwidth}
  \centering
  \includegraphics[width=0.28\textwidth]{img/Cherry_Stella444.jpg}
  \caption{
...
apply it to the degree distribution, as described by
...
graphs.\footnote{See
  ...
  for an explanation.}
In KONECT, we use the Fruchterman--Reingold algorithm \citep{b870}.  An
...
\begin{figure}
  ...
  \caption{
    ...
    Fruchterman--Reingold algorithm \citep{b870}. 
  }
\end{figure}
...
analysed to reveal properties of the graph. 
...
$\mathbf X_{\bullet j}$. 
The product of two matrices $\mathbf X\in \mathbb R^{m\times r}$ and
$\mathbf Y\in \mathbb R^{r \times n}$ is defined as
\begin{align}
...
\subsection{Characteristic Matrices of Undirected Graphs}
...
negative eigenvalues.  This matrix appears in certain contexts \citep{b875}. 

\subsection{Characteristic Matrices of Directed Graphs}
...
\begin{align}
  \mathbf Y &= \mathbf A - \mathbf A^{\mathrm T} = \mathbf Q \mathbf L \mathbf Q^{\mathrm T}
\end{align}
such that
\begin{align}
...
\citeyearpar{b869}.  It shows that the skew-symmetric matrix $\mathbf Y$ has
...
instance by Tödtli and colleagues \citeyearpar{toedtli:ctqw}.  

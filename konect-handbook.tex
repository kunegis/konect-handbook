...
begin the trust network of Advogato. 
...
In this phase of the project, extraction of datasets and maintenance of
...
on the KONECT website as downloadable tarballs.  A short overview paper of the KONECT system was
...
In 2015 and 2016, various parts of the KONECT project were placed on GitHub under the GNU
...
\item \texttt{\#trianglefree}:  The network is triangle-free, i.e., the
  network does not contain any triangles.  Cannot only be used on
...
\begin{align}
  ...
  \mathbf D_{\mathrm O}^{-1/2} \mathbf A \mathbf D_{\mathrm I}^{-1/2} - 
  \mathbf D_{\mathrm I}^{-1/2} \mathbf A^{\mathrm T} \mathbf D_{\mathrm O}^{-1/2} 
\end{align}

...
this representation \citep{b118,b646}.  When a graph is represented as a
...
\end{align*}
The incidence matrix may also be denoted $\mathbf B$ and $\mathbf M$
...
This type of matrices originates in \citep{b906}; see \citep{b907} for
...
\begin{align}
  \mathbf W &= \mathbf J - \mathbf I - 2 \mathbf A,
\end{align}
where $\mathbf J$ is the matrix completely filled with ones, and

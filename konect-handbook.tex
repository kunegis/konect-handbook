...
\section*{Abstract}
This is the handbook for the KONECT project, the \emph{Koblenz Network
  Collection}, a scientific project to collect, analyse, and provide
network datasets for researchers in all related fields of research, by
the Namur Center for Complex Systems (naXys) at the University of Namur,
Belgium, with web hosting provided
by the Institute for Web Science and Technologies (WeST) at the
...
Berlin's DAI Laboratory, as evaluation for Jérôme Kunegis's ICML 2009

...
summarized in Figure~\ref{fig:organization}. 
...
The full list of networks is given online.\footnote{
  \href{http://konect.uni-koblenz.de/networks/}{konect.uni-koblenz.de/networks}
}
...
i.e.,
\begin{align*}
  \max_i |\Lambda_{ii}| &= \left\| \mathbf A \right\|_2.
\end{align*}
...
\begin{itemize}
  \item \texttt{out.\$NETWORK}: The edges stored as tab separated values
    ...
    (most KONECT code uses a single tab character when generating such
    files). The first two  

...
ICML 2009 paper \emph{Learning Spectral Graph Transformations for Link
  Prediction}~\cite{kunegis:spectral-transformation}, codenamed
...
as part of the Web Observatory Workshop~\cite{kunegis:konect}.  In 2015
...
negative eigenvalues.  This matrix appears in certain contexts.~\cite{b875}
